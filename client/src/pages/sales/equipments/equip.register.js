...
export default function SalesEquipRegister() {
    ...
    const data = {
      ...
      if(brand!==''&&model!==''&&client!==''&&quantity!==''){
        ...
        if(response.status===200){
          ...
          alert('Erro ao registar equipamento!');
        }
      }else{
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          <Grid container spacing={3}>
            <Grid item sm={12}>
              <Button style={{marginBottom:10}} variant="contained" href={'/sales/equipments'}><ArrowBackIcon />  Voltar</Button>
